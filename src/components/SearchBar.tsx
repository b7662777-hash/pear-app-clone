    ...
    <header className="sticky top-0 z-40 flex items-center justify-between gap-2 md:gap-4 px-3 py-2 bg-transparent md:px-0 pr-0 pl-[250px] my-[10px]">
      ...
      <div className="relative flex-1 max-w-full md:max-w-[480px] mx-0 my-0 py-0 px-0 pr-0 pt-0">
        ...
        <input
          ...
          className="w-full bg-[#3d3d3d] hover:bg-[#4a4a4a] focus:bg-[#4a4a4a] rounded-lg py-2.5 text-white placeholder:text-white/50 focus:outline-none transition-colors text-sm mx-px ml-0 mr-0 pl-[100px] pr-[100px] px-[40px]" placeholder="Search Songs, Music, Artists , Playlists" />
