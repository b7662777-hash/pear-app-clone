    ...
    <header className="sticky top-0 z-40 flex items-center justify-between gap-2 md:gap-4 bg-transparent md:px-0 pr-0 pl-[250px] my-[10px] py-px px-[25px]">
      ...
      <div className="relative flex-1 max-w-full md:max-w-[480px] py-0 pt-0 mx-px my-px px-0 pr-0">
        ...
        <input
          ...
          className="w-full bg-[#3d3d3d] hover:bg-[#4a4a4a] focus:bg-[#4a4a4a] rounded-lg text-white placeholder:text-white/50 focus:outline-none transition-colors text-sm pl-[40px] pr-[40px] py-[11px] mx-[10px] mr-[100px] ml-0 mt-0 mb-0 px-[41px]" placeholder="Search Songs, Music, Artists , Playlists" />
