...
export function PlayerBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-[56px] md:h-[72px] bg-[#212121] flex flex-col z-50">
      ...
      <div className="flex-1 flex items-center justify-between px-4">
        ...
        <div className="flex items-center gap-1 md:gap-2">
          <button 
            onClick={onPrevious} 
            className="p-1.5 md:p-2 hover:bg-white/[0.1] rounded-full transition-colors" 
        ...
        {/* Center: Track info */}
        <div 
          className="flex items-center gap-2 md:gap-3 cursor-pointer group flex-1 justify-center max-w-lg min-w-0"
        ...
        >
          ...
          <div className="min-w-0">
            <h3 className="text-xs md:text-sm font-medium text-white truncate max-w-[120px] md:max-w-[200px]">
              {currentTrack.title}
            </h3>
        ...
        <div className="flex items-center gap-0.5 md:gap-1">
          ...
          <button 
            className="p-2 hover:bg-white/[0.1] rounded-full transition-colors hidden md:block"
